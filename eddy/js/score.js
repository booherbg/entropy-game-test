;(function (root) {
  ...
  E.foodWeb = function (sim) {
    ...
    let hunters = 0, crackers = 0, composites = 0;
    for (const e of live) {
      ...
      if (e.composite) composites++;          // symbiotic mergers — eat two foods as one
    }
    ...
    if (composites) links.push(composites + ' composites: two as one');
    return {
      total: live.length,
      lumen: guild[E.LUM], mineral: guild[E.MIN], decomposers: guild[E.HUM], hunters, crackers, composites,
